...
import edu.miu.quizapp.common.Constants
...
class SplashScreen : ParentFragment() {
    ...
    fun populateDB(){
        val quiz13 = Question(3L,"3) For which of the following Android is mainly developed?","A. Servers", "B. Desktops","C. Laptops","D. Mobile devices","d","Answer: (d) Mobile devices\n" +
                "\n" +
        ...
        val quiz12 = Question(4L,"4) Which of the following is the first mobile phone released that ran the Android OS?","A. HTC Hero", "B. Google gPhone","C. T - Mobile G1","D. None of the above","c","Answer: (c) T - Mobile G1\n" +
                "\n" +
        ...
        val quiz11 = Question(5L,"5) Which of the following virtual machine is used by the Android operating system?","A. JVM", "B. Dalvik virtual machine","C. Simple virtual machine","D. None of the above","b","Answer: (b) Dalvik virtual machine\n" +
                "\n" +
        ...
        val quiz10 = Question(6L,"6) Android is based on which of the following language?","A. Java", "B. C++","C. C","D. None of the above","a","Answer: (a) Java\n" +
                "\n" +
                "Explanation: Java language is mainly used to write the android code even though other languages can be used.")
        val quiz9 = Question(7L,"7) APK stands for -","A. Android Phone Kit", "B. Android Page Kit","C. Android Package Kit","D. None of the above","c","Answer: (c) Android Package Kit\n" +
                "\n" +
        ...
        val quiz8 = Question(8L,"8) What does API stand for?","A. Application Programming Interface", "B. Android Programming Interface","C. Android Page Interface","D. Application Page Interface","a","Answer: (a) Application Programming Interface\n" +
                "\n" +
        ...
        val quiz7 = Question(9L,"9) Which of the following converts Java byte code into Dalvik byte code?","A. Dalvik converter", "B. Dex compiler","C. Mobile interpretive compiler (MIC)","D. None of the above","b","Answer: (b) Dex compiler\n" +
                "\n" +
        ...
        val quiz6 = Question(10L,"10) How can we stop the services in android?","A. By using the stopSelf() and stopService() method", "B. By using the finish() method","C. By using system.exit() method","D. None of the above","a","Answer: (a) By using the stopSelf() and stopService() method\n" +
                "\n" +
        ...
        val quiz5 = Question(11L,"11) What is an activity in android?","A. android class", "B. android package","C. A single screen in an application with supporting java code","D. None of the above","c","Answer: (c) A single screen in an application with supporting java code\n" +
                "\n" +
        ...
        val quiz4 = Question(12L,"12) How can we kill an activity in android?","A. Using finish() method", "B. Using finishActivity(int requestCode)","C. Both (a) and (b)","D. Neither (a) nor (b)","c","Answer: (c) Both (a) and (b)\n" +
                "\n" +
        ...
        val quiz3 = Question(13L,"13) ADB stands for -","A. Android debug bridge", "B. Android delete bridge","C. Android destroy bridge","D. None of the above","a","Answer: (a) Android debug bridge\n" +
                "\n" +
        ...
        val quiz2 = Question(14L,"14) On which of the following, developers can test the application, during developing the android applications?",
        ...
        val quiz1 = Question(15L,"15) Which of the following kernel is used in Android?","A. MAC", "B. Windows","C. Linux","D. Redhat","c","Answer: (c) Linux\n" +
                "\n" +
        ...
        val quiz15 = Question(1L,"1) Android is","A. an operating system", "B. a web browser","C. a web server","D. None of the above","a","Answer: (a) an operating system\n" +
                "\n" +
                "Android is a software package and linux based operating system for mobile devices such as tablet computers and smartphones.")
        val quiz14 = Question(2L,"2) Under which of the following Android is licensed?", "A. OSS","B. Sourceforge","C. Apache/MIT","D. None of the above","c","Answer: (c) Apache/MIT\n" +
                "\n" +
